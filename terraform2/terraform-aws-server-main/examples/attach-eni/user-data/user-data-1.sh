#!/bin/bash
#
# This script is meant to run in the User Data of an EC2 instance to attach an ENI by ID
...
# Attach the ENI
/usr/local/bin/attach-eni --eni-id "${eni_id_a}" --device-index 1
/usr/local/bin/attach-eni --eni-id "${eni_id_b}" --device-index 2
